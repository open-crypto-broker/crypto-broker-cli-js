...
- Allow distributed trace context propagation for dynatrace (#70)
- Api update benchmark (#69)

### 🐛 Bug Fixes

- Make uid in Dockerfile configurable (#71)

### ⚙️ Miscellaneous Tasks

- Bump version to v0.4.1
- Bump version to v0.4.1-rc.0
- Updated packages, override tslib (#72)
...
- Add license check (#56)
- Add version sync check workflow (#55)
- Added git hash to version (#51)
- Add dependabot config (#50)
- Version number (#49)

### 🐛 Bug Fixes

- Adjust permission for npm version bump (#58)

### 🚜 Refactor

- Adjust workflow files (#54)

### ⚙️ Miscellaneous Tasks

- Bump version to v0.3.0
- Bump version to v0.3.0-rc.0
